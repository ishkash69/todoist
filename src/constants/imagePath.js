export default {
    ic_eye_view: require("../assets/images/view.png"),
    ic_eye_hide: require("../assets/images/hidden.png"),
    icFirstOnboard:require('../assets/images/ic_vector.png'),
    icSecondOnboard:require('../assets/images/ic_vector3.png'),
    icThird:require('../assets/images/ic_vector2.png'),
